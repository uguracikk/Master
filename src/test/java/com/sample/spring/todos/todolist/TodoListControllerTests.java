...
import com.sample.spring.todos.TestWebSecurityConfig;
import com.sample.spring.todos.todolist.TodoItem;
import com.sample.spring.todos.todolist.TodoItemCreatedResponse;
import com.sample.spring.todos.todolist.TodoItemRepository;
import com.sample.spring.todos.todolist.TodoItemRequest;
import com.sample.spring.todos.todolist.TodoList;
import com.sample.spring.todos.todolist.TodoListCreatedResponse;
import com.sample.spring.todos.todolist.TodoListRepository;
import com.sample.spring.todos.todolist.TodoListRequest;
...
public class TodoListControllerTests {
    ...
    @Test
    @WithUserDetails("dummy1@example.com")
    ...
    public void testUpdateItem() throws Exception {
        User owner = new User();
        TodoList list = new TodoList("Dummy", owner);
//        list.setOwner(owner);
